...
public class TicTacToeController
{
    ...
    private final String  STATUS_CATS         = "Gatto sta giocando";
    private final String  STATUS_X_WINS       = "X vince!";
    private final String  STATUS_O_WINS       = "O vince!";
    private final String  STATUS_X_MOVES      = "X muove";
    private final String  STATUS_O_MOVES      = "O muove";
    private final String  STATUS_CP_MOVES     = "PC sta pensando...";
